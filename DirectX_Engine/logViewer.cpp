...
bool LogViewer::initialize(Graphics * g, Input * i)
{
	...
	try
	{
		m_rcTitle = RectMake(logViewerNS::X + 4, logViewerNS::Y + 4, logViewerNS::WIDTH - 4, logViewerNS::LOG_HEIGHT);
		m_rcLogBox = RectMake(logViewerNS::X + 5, logViewerNS::Y + logViewerNS::LOG_HEIGHT, logViewerNS::WIDTH - (5 * 2), logViewerNS::LOG_HEIGHT);
		...
		success = SystemUIDialog::initializeDialog(g, i, logViewerNS::X, logViewerNS::Y, logViewerNS::WIDTH, logViewerNS::HEIGHT, logViewerNS::MARGIN);
	}
	catch (...)
	{
