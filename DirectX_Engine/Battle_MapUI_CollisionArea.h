#ifndef _BATTLE_MAPUI_COLLISIONAREA_H
#define _BATTLE_MAPUI_COLLISIONAREA_H
#define WIN32_LEAN_AND_MEAN

class CBattle_MapUI_CollisionArea;
...
class CBattle_MapUI_CollisionArea : public Entity
{
private:
...
#endif // !_BATTLE_MAPUI_COLLISIONAREA_H
