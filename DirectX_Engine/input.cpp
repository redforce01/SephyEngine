...
void Input::mouseWheelIn(int zDelta)
{
	if (zDelta > 0 || zDelta < 0) mouseWheelRoll = true;
	else mouseWheelRoll = false;

	if (zDelta > 0) mouseWheelRollUp = true;
	else mouseWheelRollUp = false;

	if (zDelta < 0) mouseWheelRollDown = true;
	else mouseWheelRollDown = false;
}

bool Input::isMouseWheelUp()
{
	return mouseWheelRollUp;
}

bool Input::isMouseWheelDown()
{
	return mouseWheelRollDown;
}
